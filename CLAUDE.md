...
| `make icon` | Regenerates `Tools/Icon/AppIcon.icns` from `Tools/Icon/CreateIcon.swift` |
| `make background` | Regenerates `Tools/Dmg/Background.tiff` from `Tools/Dmg/CreateBackground.swift` |
...
`Tools/Dmg/CreateBackground.swift`). Any replacement must be 700×460 pt and keep the arrow in
