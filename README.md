...
- ✅ **Instant 3-finger swipe** - your trackpad swipe switches spaces with zero animation too
...
The "Instant 3-Finger Swipe" feature — intercepting real trackpad swipes and replacing them with instant switches — is ported from [iss](https://github.com/joshuarli/iss) by [@joshuarli](https://github.com/joshuarli), which also pioneered the event augmentation required on macOS 27+.
